...
// import { savePrimaryIdSelfie } from "../../store/slices/buyerOnboardingSlice";
                    ...
                    (blob) => {
                        if (blob) {
                            ...
                            reader.onloadend = () => {
                                ...
                                // if (isPrimaryId) dispatch(savePrimaryIdSelfie(base64data));
                                // else dispatch(savePrimaryIdSelfie(base64data));
